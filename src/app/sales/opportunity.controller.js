(function() {
  ...
  /** @ngInject */
  function OpportunityController ( $scope, $modalInstance, Users, Products, PROSPECT_STATUS) {
    
    var _this = this;
    
    _this.status = PROSPECT_STATUS;
    
    _this.opportunity = { salesPerson: undefined, 
                             product: undefined, 
                             prospect: undefined, 
                             status: undefined,
                             potential: 0.0,
    ...
    _this.ok = function () {
      $modalInstance.close(_this.opportunity);
    };
    ...
    $scope.opportunity          = _this.opportunity;
